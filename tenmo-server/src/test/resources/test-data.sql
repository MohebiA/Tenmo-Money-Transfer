...
INSERT INTO account (user_id,balance) VALUES (1001, 0.00); -- 2001
INSERT INTO account (user_id,balance) VALUES (1002, 1000.00); -- 2002
INSERT INTO account (user_id,balance) VALUES (1003, 500.50); -- 2003
...
SELECT
	...
	(SELECT a.user_id
	 ...
	 GROUP BY a.user_id) AS to_userid,

	teu.username AS username,
	...
	(SELECT tu.username
	 ...
	 GROUP BY a.user_id, tu.username) AS to_username
